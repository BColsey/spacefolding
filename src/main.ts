...
const knownCommands = ['serve', 'ingest', 'ingest-project', 'score', 'explain', 'graph', 'watch', 'export', 'import', 'symbols', 'health', 'download-model', 'retrieve', 'backfill-embeddings', 'help'];
